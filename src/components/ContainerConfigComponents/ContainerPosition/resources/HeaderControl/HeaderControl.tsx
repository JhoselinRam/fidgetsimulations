...
function HeaderControl({ setAspectRatio }: HeaderControlProps): JSX.Element {
  return (
    <ConfigSection.Header>
      ...
      <Info placement="left" crossOffset={20}>
        <p>Sets the container aspect ratio to 1:1</p>
        <p className="mt-2">
          To ensure the correct aspect ratio the container height will be
          changed.
        </p>
      </Info>
    </ConfigSection.Header>
