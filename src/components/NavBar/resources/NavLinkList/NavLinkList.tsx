...
function NavLinkList({ children }: NavLinkListProps): JSX.Element {
  ...
  return (
    <ul
      className={`flex flex-col gap-5 absolute top-full left-0 w-screen pr-0 pl-3 bg-tuatara-950 pb-2
		md:static md:flex-row md:items-center md:w-auto md:pr-5 md:scale-y-100 md:pl-0
