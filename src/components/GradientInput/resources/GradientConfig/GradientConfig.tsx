...
import GradientConfigClose from "../GradientConfigClose/GradientConfigClose"
...
function GradientConfig({ ...formProps }: GradientConfigProps): JSX.Element {
  ...
  return (
    <DialogTrigger>
      ...
      <Popover
        className="group bg-tuatara-900 border-tuatara-600 text-zinc-950 border rounded-md text-xs w-full max-w-60
      ...
      >
        <OverlayArrow>
          <svg
            ...
            height={12}
            viewBox="0 0 12 12"
            className="stroke-tuatara-600 fill-tuatara-900 group-data-[placement=right]:rotate-90
