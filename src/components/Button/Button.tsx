...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (props, ref): JSX.Element => {
    ...
    const styledTypes: StyledTypes = {
      accent:
        "data-[hovered]:bg-accent-blue-600 text-zinc-200 data-[pressed]:!bg-accent-blue-500 bg-accent-blue-700 border border-1 border-tuatara-950",
      regular:
        "data-[hovered]:bg-tuatara-400 data-[pressed]:bg-tuatara-300 bg-tuatara-500 border border-1 border-tuatara-950",
    ...
    return (
      <RACButton
        className={`
    rounded-md py-0 px-4 data-[focused]:outline-none 
