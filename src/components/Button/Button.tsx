...
function Button(props: ButtonProps): JSX.Element {
  ...
  const styledTypes: StyledTypes = {
    accent:
      "data-[hovered]:bg-accent-blue-800 data-[pressed]:bg-accent-blue-900 bg-accent-blue-700",
    regular:
      "data-[hovered]:bg-tuatara-900 data-[pressed]:bg-tuatara-950 bg-tuatara-800",
